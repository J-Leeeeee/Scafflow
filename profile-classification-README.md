...
---
## 2A. Topic Confidence Score Calculation

Topic confidence responses are collected separately from the five learner-profile constructs.

Each topic is scored on a 1–5 scale:
...
TopicConfidenceScore = Sum(Answered Topic Scores) / Number of Answered Topics

Topic confidence is not used to replace Self-Efficacy or Competence. It is used as a domain-readiness overlay for the assigned profile.
